...
import { getDieticianMemberships } from "../../features/slices/dieticians/dieticianMembershipsSlice";

const DieticianMemberships = () => {
  const dispatch = useAppDispatch();

  const { memberships, loading } = useAppSelector(
    (state) => state.dieticianMemberships
  );

  const fetchUserMemberships = () => {
    dispatch(getDieticianMemberships())
      .unwrap()
      .then(console.log)
...
export default DieticianMemberships;